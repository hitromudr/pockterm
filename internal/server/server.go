...
type Presence interface {
	...
	Background(session string) (shells, monitors, other, agents int)
}
...
func serveSessions(o Options, w http.ResponseWriter, r *http.Request) {
	...
	if o.Presence != nil {
		for i := range sessions {
			...
			sessions[i].Shells, sessions[i].Monitors, sessions[i].Other, sessions[i].Agents = o.Presence.Background(sessions[i].Name)
		}
	}
